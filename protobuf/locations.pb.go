...
// The request message containing the services's name.
...
func (x *NewLocation) GetLongitude() float32 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
func (x *NewLocation) GetLatitude() float32 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
var file_protobuf_locations_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x08, 0x4c,
